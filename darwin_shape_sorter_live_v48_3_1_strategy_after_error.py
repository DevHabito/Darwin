...
"""
DARWIN v48.3.1 — Shape Sorter ao vivo: estratégia após erro
...
class App:
    ...
    def draw(self):
        ...
        c.create_text(35,38,anchor="w",text="DARWIN v48.3.1 — estratégia após erro",font=("Segoe UI",17,"bold"),fill=self.TEXT)
