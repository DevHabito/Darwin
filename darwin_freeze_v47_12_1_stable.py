...
"""
DARWIN — Freeze Baseline v47.12.1 Stable

Congela o estado atual da v47.12.1 depois do relatório consolidado do ciclo cognitivo.
...
Uso:
    py darwin_freeze_v47_12_1_stable.py --dry-run
    py darwin_freeze_v47_12_1_stable.py

Incluir logs, se houver:
    py darwin_freeze_v47_12_1_stable.py --include-logs
"""
...
README_TEXT = """DARWIN — Baseline v47.12.1 Stable
==================================

Esta baseline representa o marco estável da v47.12.1:
...
- tabela tension_cognitive_cycle_reports;
- comando 10z para visualizar o prontuário do ciclo;
- cadeia auditável:
  tensão → comparação → influência → hipótese → linhagem → validação → relatório.
...
começar v47.13/v48 a partir da pasta operacional atual, não desta baseline.

Direção natural:
usar o relatório consolidado como memória autobiográfica operacional mínima:
Darwin deve conseguir revisar ciclos passados antes de abrir novas rotinas semelhantes.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Congela baseline estável Darwin v47.12.1.")
    ...
    baseline_name = f"baseline_v47_12_1_stable_{now_stamp()}"
    baseline_dir = BASELINES_DIR / baseline_name

    print("=" * 72)
    print("DARWIN — FREEZE BASELINE v47.12.1 STABLE")
    print("=" * 72)
    ...
    if not args.dry_run:
        ...
        print()
        print(f"Baseline v47.12.1 congelada com sucesso em: {baseline_dir}")
        ...
        if warnings:
            ...
            print("Baseline limpa: sem tensões artificiais, rotinas, comparações, influências, linhagens ou relatórios pendentes.")
        print("Próximo passo: iniciar v47.13/v48 a partir da pasta operacional atual, não desta baseline.")
