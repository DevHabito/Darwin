...
"""
DARWIN — Freeze Baseline v47.5 Stable

Congela o estado atual da v47.5 depois da reidratação de tensões persistentes.

Este script cria uma baseline segura contendo:
- darwin_v61_nursery_v47.py
- darwin_tension_persistence_v47.py
- ferramentas v47/v47.5 de diagnóstico, teste e painel
...
- Use antes de começar qualquer v48/v47.6 comportamental.

Uso:
    py darwin_freeze_v47_5_stable.py

Teste seco:
    py darwin_freeze_v47_5_stable.py --dry-run

Incluir logs, se houver:
    py darwin_freeze_v47_5_stable.py --include-logs
"""
...
README_TEXT = """DARWIN — Baseline v47.5 Stable
================================

Esta baseline representa o marco estável da v47.5:
...
começar v47.6/v48 a partir da pasta operacional atual, não desta baseline.

Direção natural:
fazer Darwin usar tensões reidratadas como compromisso executivo real no próximo passo autônomo.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Congela baseline estável Darwin v47.5.")
    ...
    baseline_name = f"baseline_v47_5_stable_{now_stamp()}"
    baseline_dir = BASELINES_DIR / baseline_name

    print("=" * 72)
    print("DARWIN — FREEZE BASELINE v47.5 STABLE")
    print("=" * 72)
    ...
    if not args.dry_run:
        ...
        print()
        print(f"Baseline v47.5 congelada com sucesso em: {baseline_dir}")
        print(f"Pacote ZIP: {zip_path}")
        print("Próximo passo: iniciar v47.6/v48 a partir da pasta operacional atual, não desta baseline.")
