...
"""
DARWIN — Freeze Baseline v47.6.1 Stable

Congela o estado atual da v47.6.1 depois do compromisso executivo real
e da higiene do painel 10c.

Este script cria uma baseline segura contendo:
- darwin_v61_nursery_v47.py
- darwin_tension_persistence_v47.py
- ferramentas v47/v47.5/v47.6/v47.6.1 de diagnóstico, teste e painel
...
- Use antes de começar qualquer v47.7/v48 comportamental.

Uso:
    py darwin_freeze_v47_6_1_stable.py

Teste seco:
    py darwin_freeze_v47_6_1_stable.py --dry-run

Incluir logs, se houver:
    py darwin_freeze_v47_6_1_stable.py --include-logs
"""
...
README_TEXT = """DARWIN — Baseline v47.6.1 Stable
=================================

Esta baseline representa o marco estável da v47.6.1:
...
- repair documentado do painel 10c.
...
começar v47.7/v48 a partir da pasta operacional atual, não desta baseline.

Direção natural:
fazer o compromisso executivo deixar de escolher apenas predict/validate direto
e passar a construir uma micro-rotina de resolução para cada tensão aberta.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Congela baseline estável Darwin v47.6.1.")
    ...
    baseline_name = f"baseline_v47_6_1_stable_{now_stamp()}"
    baseline_dir = BASELINES_DIR / baseline_name

    print("=" * 72)
    print("DARWIN — FREEZE BASELINE v47.6.1 STABLE")
    print("=" * 72)
    ...
    if not args.dry_run:
        ...
        print()
        print(f"Baseline v47.6.1 congelada com sucesso em: {baseline_dir}")
        print(f"Pacote ZIP: {zip_path}")
        print("Próximo passo: iniciar v47.7/v48 a partir da pasta operacional atual, não desta baseline.")
