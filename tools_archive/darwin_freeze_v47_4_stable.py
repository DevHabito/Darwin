...
"""
DARWIN — Freeze Baseline v47.4 Stable

Congela o estado atual da v47 depois da memória executiva persistente de tensões.

Este script cria uma baseline segura contendo:
- darwin_v61_nursery_v47.py
- darwin_tension_persistence_v47.py
- ferramentas v47 de diagnóstico/teste/painel
...
- Use antes de começar qualquer v48/v47.5 comportamental.

Uso:
    py darwin_freeze_v47_4_stable.py

Teste seco:
    py darwin_freeze_v47_4_stable.py --dry-run

Incluir logs, se houver:
    py darwin_freeze_v47_4_stable.py --include-logs
"""
...
README_TEXT = """DARWIN — Baseline v47.4 Stable
================================

Esta baseline representa o primeiro marco estável da v47:
...
começar a v48/v47.5 a partir da cópia operacional atual, não desta baseline.
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Congela baseline estável Darwin v47.4.")
    ...
    baseline_name = f"baseline_v47_4_stable_{now_stamp()}"
    baseline_dir = BASELINES_DIR / baseline_name

    print("=" * 72)
    print("DARWIN — FREEZE BASELINE v47.4 STABLE")
    print("=" * 72)
    ...
    if not args.dry_run:
        ...
        print()
        print(f"Baseline v47.4 congelada com sucesso em: {baseline_dir}")
        print(f"Pacote ZIP: {zip_path}")
        print("Próximo passo: iniciar v48/v47.5 a partir da pasta operacional atual, não desta baseline.")
